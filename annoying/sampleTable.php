...
<body>
    ...
    <div class="title_container">
        <h1 class="site__title mega">Periodic Table of Elements</h1>
    </div>
    ...
    <div class="wrapper">
        <ul class="main">
            ...
            <li data-pos="57-71" class="type-8 preview">La-Lu<span>Lanthanide</span></li>
            ...
            <li data-pos="89-103" class="type-9 preview">Ac-Lr<span>Actinide</span></li>
            ...
            <li data-pos="116" data-nb="(289)" class="type-7 cat-3">Uuh<span>Ununhexium</span></li>
            <li data-pos="117" data-nb="(289)" class="type-0 cat-3">Uus<span>Ununseptum</span></li>
            <li data-pos="118" data-nb="(289)" class="type-2 cat-3">Uuo<span>Ununoctium</span></li>

            <!-- First Bottom Row -->

            <li class="empty bottom"></li>
            <li class="empty bottom"></li>
            <li data-pos="57" data-nb="600" class="type-8 bottom">La<span>Lanthanum</span></li>
            <li data-pos="58" data-nb="600" class="type-8 bottom">Ce<span>Cerium</span></li>
            <li data-pos="59" data-nb="600" class="type-8 bottom">Pr<span>Praseodymi</span></li>
            <li data-pos="60" data-nb="600" class="type-8 bottom">Nd<span>Neodymium</span></li>
            <li data-pos="61" data-nb="600" class="type-8 bottom">Pm<span>Promethium</span></li>
            <li data-pos="62" data-nb="600" class="type-8 bottom">Sm<span>Samarium</span></li>
            <li data-pos="63" data-nb="600" class="type-8 bottom">Eu<span>Europium</span></li>
            <li data-pos="64" data-nb="600" class="type-8 bottom">Gd<span>Gadolinium</span></li>
            <li data-pos="65" data-nb="600" class="type-8 bottom">Tb<span>Terbium</span></li>
            <li data-pos="66" data-nb="600" class="type-8 bottom">Dy<span>Dysprosium</span></li>
            <li data-pos="67" data-nb="600" class="type-8 bottom">Ho<span>Holmium</span></li>
            <li data-pos="68" data-nb="600" class="type-8 bottom">Er<span>Erbium</span></li>
            <li data-pos="69" data-nb="600" class="type-8 bottom">Tm<span>Thulium</span></li>
            <li data-pos="70" data-nb="600" class="type-8 bottom">Tb<span>Ytterbium</span></li>
            <li data-pos="71" data-nb="600" class="type-8 bottom">Lu<span>Lutetium</span></li>
            <li class="empty bottom"></li>
            ...
            <li class="empty"></li>
            <li class="empty"></li>
            <li data-pos="89" data-nb="900" class="type-9">Ac<span>Actinium</span></li>
            <li data-pos="90" data-nb="900" class="type-9">Th<span>Thorium</span></li>
            <li data-pos="91" data-nb="900" class="type-9">Pa<span>Protactinium</span></li>
            <li data-pos="92" data-nb="900" class="type-9">U<span>Uranium</span></li>
            <li data-pos="93" data-nb="900" class="type-9">Np<span>Neptunium</span></li>
            <li data-pos="94" data-nb="900" class="type-9">Pu<span>Plutonium</span></li>
            <li data-pos="95" data-nb="900" class="type-9">Am<span>Americium</span></li>
            <li data-pos="96" data-nb="900" class="type-9">Cm<span>Curium</span></li>
            <li data-pos="97" data-nb="900" class="type-9">Bk<span>Berkelium</span></li>
            <li data-pos="98" data-nb="900" class="type-9">Cf<span>Californium</span></li>
            <li data-pos="99" data-nb="900" class="type-9">Es<span>Einsteinium</span></li>
            <li data-pos="100" data-nb="900" class="type-9">Fm<span>Fermium</span></li>
            <li data-pos="101" data-nb="900" class="type-9">Md<span>Mendelevium</span></li>
            <li data-pos="102" data-nb="900" class="type-9">No<span>Nobelium</span></li>
            <li data-pos="103" data-nb="900" class="type-9">Lr<span>Lawrencium</span></li>
            <li class="empty"></li>
    ...
    <div class="content">
        <!-- <span class="atomic">25</span>
        <span class="short">Mn</span>
        <span class="name">Manganese</span>
        <div class="info">
        <span class="meltingPoint">Melting Point: 771</span>
        <span class="boilingPoint">Boiling Point: 352</span>
        <span class="discovered">Discovered: 1901</span>
    -->
    </div>

    <!-- <div id="gradient"/> -->
    <script src="./bower_components/jquery/dist/jquery.min.js" charset="utf-8"></script>
    <script src="./bower_components/animate.css/animate.css" charset="utf-8"></script>
    <script src="./js/sampleTable.js" charset="utf-8"></script>
    <!-- <script>
      function testAnim(x) {
